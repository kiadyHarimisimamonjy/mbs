                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format($checkout->montant, 0, ',', ' ')}} Ar</td>
                                    <td>
                                        {{ number_format($checkout->derniermontant, 0, ',', ' ')}} Ar
                                    </td>
                                    <td>
                                         {{ number_format($checkout->montant-$checkout->derniermontant, 0, ',', ' ')}} Ar
                                    </td>

                                    <td>
                                        <a class="btn btn-primary" href="{{ route('checkouts.show',$checkout->id) }}">
                                       voir
                                        </a>
                                        @if ( $checkout->isclosed===0 )
                                        <a class="btn btn-success" href="{{ route('checkouts.openedit',$checkout->id) }}">
                                            modifier
                                             </a>
                                        @endif
